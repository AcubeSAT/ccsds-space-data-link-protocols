...
*/
    ...
    public:
        SecurityAssociation(const DefsAndUtils::SecurityAssociationUser user, const uint16_t securityParameterIndex,
                            const etl::optional<DefsAndUtils::AuthenticationAlgorithm>& authenticationAlgorithm,
                            const etl::optional<DefsAndUtils::EncryptionAlgorithm>& encryptionAlgorithm,
                            const etl::optional<etl::string[DefsAndUtils::MaxAuthenticationKeyLength]> authKey)
            : user(user),
            ...
            if (authenticationAlgorithm.has_value() && authKey.has_value()) {
                switch (authenticationAlgorithm.value()) {
                    case (DefsAndUtils::AuthenticationAlgorithm::HMAC_SHA256_40_BIT):
                        ...
                        authenticationKey = authKey.value();
    ...
    private:
        ...
        /**
         * Defines which of the 3 services is offered by this SA: authentication, encryption, authenticated encryption
         */
        DefsAndUtils::SecurityAssociationServiceType saServiceType;
         ...
         */
        DefsAndUtils::SecurityAssociationUser user;
         ...
         */
        etl::optional<DefsAndUtils::AuthenticationAlgorithm> authenticationAlgorithm;
         ...
         */
        etl::optional<DefsAndUtils::EncryptionAlgorithm> encryptionAlgorithm;
