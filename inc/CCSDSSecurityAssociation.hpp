...
*/
    ...
    public:
        ...
        applySecurityTC(TransferFrameTC *frameTc, uint16_t transferFrameDataFieldLength, uint8_t vid, uint8_t mapid);
         ...
         */
        SDLSVerificationStatusCode
        processSecurityTC(TransferFrameTC *frameTc, uint16_t transferFrameDataFieldLength, uint8_t vid, uint8_t mapid);
