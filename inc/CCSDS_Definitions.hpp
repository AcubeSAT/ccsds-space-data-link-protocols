...
#define ERROR_CONTROL_FIELD_EXISTS 0
	...
	#define FRAME_DATA_FIELD_MAX_SIZE (TRANSFER_FRAME_SIZE - PRIMARY_HEADER_SIZE - SECONDARY_HEADER_SIZE - 6)
#elif OPERATIONAL_CONTROL_FIELD_EXISTS
	#define FRAME_DATA_FIELD_MAX_SIZE (TRANSFER_FRAME_SIZE - PRIMARY_HEADER_SIZE - SECONDARY_HEADER_SIZE - 4)
#elif ERROR_CONTROL_FIELD_EXISTS
	#define FRAME_DATA_FIELD_MAX_SIZE (TRANSFER_FRAME_SIZE - PRIMARY_HEADER_SIZE - SECONDARY_HEADER_SIZE - 2)
#else
