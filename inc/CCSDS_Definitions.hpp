...
const uint16_t tm_frame_data_field_size = (tm_transfer_frame_size - tm_primary_header_size - tm_secondary_header_size - 6);
#elif tm_operational_control_field_exists
const uint16_t tm_frame_data_field_size = (tm_transfer_frame_size - tm_primary_header_size - tm_secondary_header_size - 4);
#elif tm_error_control_field_exists
const uint16_t tm_frame_data_field_size = (tm_transfer_frame_size - tm_primary_header_size - tm_secondary_header_size - 2);
#else
