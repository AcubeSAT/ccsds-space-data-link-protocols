...
namespace CCSDSDataLinkLayer {
    struct CLCW {
        ...
        explicit CLCW(const uint32_t operationalControlField) : clcw(operationalControlField) {};
    ...
    public:
         ...
         */
        [[nodiscard]] const bool getControlWordType() const {
            return clcw >> 31U;
        }
         ...
         * @see 4.2.2 from Telecommand Part 2
         */
        [[nodiscard]] const uint8_t getClcwVersion() const {
            return (clcw >> 29U) & 0x3;
        }
         ...
         */
        [[nodiscard]] const uint8_t getStatusField() const {
            return (clcw >> 26U) & 0x7;
        }
         ...
         */
        [[nodiscard]] const uint8_t getCopInEffect() const {
            return (clcw >> 24U) & 0x3;
        }
         ...
         */
        [[nodiscard]] const bool getNoRfAvailable() const {
            return (clcw >> 15U) & 0x1;
        }
         ...
         */
        [[nodiscard]] const bool getNoBitLock() const {
            return (clcw >> 14U) & 0x1;
        }
         ...
         */
        [[nodiscard]] const bool getLockout() const {
            return (clcw >> 13U) & 0x1;
        }
         ...
         */
        [[nodiscard]] const bool getWait() const {
            return (clcw >> 12U) & 0x1;
        }
         ...
         */
        [[nodiscard]] const bool getRetransmit() const {
            return (clcw >> 11U) & 0x1;
        }
         ...
         */
        [[nodiscard]] const uint8_t getFarmBCounter() const {
            return (clcw >> 9U) & 0x3;
        }
         ...
         */
        [[nodiscard]] const uint8_t getReportValue() const {
            return clcw & 0xFF;
        }
    };
} // namespace CCSDSDataLinkLayer