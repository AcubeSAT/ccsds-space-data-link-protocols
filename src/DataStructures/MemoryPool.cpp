...
namespace CCSDSDataLinkLayer {
    ...
    uint8_t *MemoryPool<SizeBytes, MaxAllocatedBlocks>::allocateBlock(const uint16_t blockLength, const uint8_t *packetSource) {
    ...
    template<std::size_t SizeBytes, std::size_t MaxAllocatedBlocks>
    bool MemoryPool<SizeBytes, MaxAllocatedBlocks>::deleteBlock(const uint8_t *blockStart, uint16_t blockLength) {
    ...
    template<std::size_t SizeBytes, std::size_t MaxAllocatedBlocks>
    std::pair<uint16_t, MasterChannelAlert> MemoryPool<SizeBytes, MaxAllocatedBlocks>::findFit(const uint16_t packetLength) {
    ...
    template<std::size_t SizeBytes, std::size_t MaxAllocatedBlocks>
    uint8_t *MemoryPool<SizeBytes, MaxAllocatedBlocks>::getMemory() {
        return &memory[0];
    }
} // namespace CCSDSDataLinkLayer
