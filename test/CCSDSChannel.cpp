...
//             master_channel.addVC(3, false, 1024, true, true, true, 32, 32, true, true, 8, true,
...
//
//             MasterChannel master_channel = MasterChannel();
//             master_channel.addVC(3, false, 8, true, true, true, 32, 32, true, true, 11, true,
//                                  SynchronizationFlag::OCTET_SYNCHRONIZED_FORWARD_ORDERED, 255, 10, 10, 3,
//                                  map_channels);
//
...
//
//             CLCW parsedClcw = CLCW(controlWordType, clcwVersion, statusField, copInEffect, vcId, spare, noRfAvailable,
//                                    bitLock,
