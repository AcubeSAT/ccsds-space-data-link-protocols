...
TEST_CASE("CCSDS TC Channel Model") {
	...
	master_channel.addVC(3, 1024, true, 32, 32, true, true, true, 8, SynchronizationFlag::FORWARD_ORDERED, 255, 10, 10, 3,
	                     map_channels);
...
TEST_CASE("MAPP blocking") {
	...
	err = serv_channel.storeTC(data, 11, 3, 2, 10, ServiceType::TYPE_AD);
