...
namespace CCSDSDataLinkLayer {
    TEST_CASE("Security Association (40 bit HMAC authentication)") {
        ...
        master_channel.addVC(0, true, 128, true, true, true, 2, 2, false, true, 8, true,
        ...
        SECTION("Normal Operation") {
            ...
            // spi
            CHECK(((static_cast<uint16_t>(frameData[6]) << 8) | static_cast<uint16_t>(frameData[7])) ==
        ...
        SECTION("Multiple frames") {
            ...
            CHECK(verCode == NO_FAILURE);
            // spi
            CHECK(((static_cast<uint16_t>(frameData1[6]) << 8) | static_cast<uint16_t>(frameData1[7])) ==
                  SecurityParameterIndex);
            // sequence number
            ...
            CHECK(verCode == NO_FAILURE);
            // spi
            CHECK(((static_cast<uint16_t>(frameData2[6]) << 8) | static_cast<uint16_t>(frameData2[7])) ==
                  SecurityParameterIndex);
            // sequence number
        ...
        SECTION("Wrong MAC") {
            ...
            CHECK(serv_channel.getAvailableInFramesAfterVCReceptionTypeADRxTC(0) ==
                  MaxReceivedRxTcInVirtualChannelBuffer - 2);
