...
TEST_CASE("Service Channel") {
	...
	// Rx side
	// new packet
	uint8_t pckt[] = {0x00, 0x01, 0x02, 0x00, 0x00, 0xA0, 0x09, 0x08, 0x07,0x06, 0x05, 0x04, 0x03, 0x02, 0x01 };
	uint8_t pckt1[] = {0x10, 0xB1, 0x00, 0x03, 0x08, 0xA5, 0x15, 0x1C, 0x21, 0X40};
