...
TEST_CASE("Service Channel") {
	...
	*/
	...
	uint8_t invalid_vcid_TM[TmTransferFrameSize] = {0x00, 0x0F, 0x00, 0x03, 0x04, 0xA2, 0xB3,
	                                                0x1F, 0xD6, 0xA2, 0xB3, 0x1F, 0x7B, 0x7C};
	uint8_t invalid_crc_TM[TmTransferFrameSize] = {0x00, 0x01, 0x00, 0x03, 0x04, 0xA2, 0xB3,
	                                               0x5B, 0x54, 0xA2, 0xB3, 0x1F, 0xD6, 0x01};

	// Packets that carry a CLCW
	uint8_t valid_no_crc_TM[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                0xB3, 0x5B, 0x54, 0xA2, 0xC7, 0x0};
	uint8_t valid_no_crc_TM2[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                 0xB3, 0x5B, 0x54, 0xA2, 0xD0, 0x0};
	uint8_t valid_no_crc_TM3[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                 0xB3, 0x5B, 0x54, 0xA2, 0xD8, 0x0};
	uint8_t valid_no_crc_TM4[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                 0xB3, 0x5B, 0x54, 0xA2, 0xC7, 0x01};
	uint8_t valid_no_crc_TM5[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                 0xB3, 0x5B, 0x54, 0xA2, 0xD0, 0x01};
	uint8_t valid_no_crc_TM6[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                 0xB3, 0x5B, 0x54, 0xA2, 0xD8, 0x01};
	uint8_t valid_no_crc_TM7[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                 0xB3, 0x5B, 0x54, 0xA2, 0xC8, 0x01};
	uint8_t valid_no_crc_TM8[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                 0xB3, 0x5B, 0x54, 0xA2, 0xC7, 0x04};
	uint8_t valid_no_crc_TM9[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                 0xB3, 0x5B, 0x54, 0xA2, 0xC7, 0x05};
	uint8_t valid_no_crc_TM10[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                  0xB3, 0x5B, 0x54, 0xA2, 0xC8, 0x05};
	uint8_t valid_no_crc_TM11[TmTransferFrameSize] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2,
	                                                  0xB3, 0x5B, 0x54, 0xA2, 0xD8, 0x05};
