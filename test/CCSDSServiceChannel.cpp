...
TEST_CASE("Service Channel") {
    ...
    */
    ...
    uint8_t valid_no_crc_TM[] = {0x00, 0x05, 0x00, 0x03, 0x04, 0xA2, 0xB3, 0x5B, 0x54, 0xA2, 0xB3, 0x1F};
    ...
    err = serv_channel.storeTC(pckt_type_a, 9, 2, 0, 0, ServiceType::TYPE_AD);
...
TEST_CASE("CLCW construction at VC Reception") {
    ...
    CLCW clcw = CLCW(serv_channel.getClcwTransferFrameDataBuffer()[TmTransferFrameSize - 4 -
                                                                   2 * virtualChannel.frameErrorControlFieldPresent]
                             << 24 | serv_channel.getClcwTransferFrameDataBuffer()[TmTransferFrameSize - 4 - 2 *
                                                                                                             virtualChannel.frameErrorControlFieldPresent +
                                                                                   1]
                             << 16 | serv_channel.getClcwTransferFrameDataBuffer()[TmTransferFrameSize - 4 - 2 *
                                                                                                             virtualChannel.frameErrorControlFieldPresent +
                                                                                   2]
                             << 8 | serv_channel.getClcwTransferFrameDataBuffer()[TmTransferFrameSize - 4 - 2 *
                                                                                                            virtualChannel.frameErrorControlFieldPresent +
                                                                                  3]);
    ...
    CHECK(serv_channel.getClcwInBuffer().getLockout() == false);
    CLCW clcw2 = CLCW(serv_channel.getClcwTransferFrameDataBuffer()[TmTransferFrameSize - 4 -
                                                                    2 * virtualChannel.frameErrorControlFieldPresent]
                              << 24 | serv_channel.getClcwTransferFrameDataBuffer()[TmTransferFrameSize - 4 - 2 *
                                                                                                              virtualChannel.frameErrorControlFieldPresent +
                                                                                    1]
    ...
    CLCW clcw3 = CLCW(serv_channel.getClcwTransferFrameDataBuffer()[TmTransferFrameSize - 4 -
                                                                    2 * virtualChannel.frameErrorControlFieldPresent]
                              << 24 | serv_channel.getClcwTransferFrameDataBuffer()[TmTransferFrameSize - 4 - 2 *
                                                                                                              virtualChannel.frameErrorControlFieldPresent +
                                                                                    1]
