...
TEST_CASE("Initiate FOP Directives") {
	...
	MasterChannel master_channel_fop = MasterChannel(true, true, 0);
	master_channel_fop.addVC(3, true, 1024, 20, true, 32, 32, 32, true, true, SynchronizationFlag::FORWARD_ORDERED,
	                         map_channels_fop);
