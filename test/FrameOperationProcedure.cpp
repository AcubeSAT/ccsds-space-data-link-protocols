...
namespace CCSDSDataLinkLayer {
    TEST_CASE("Initiate FOP Directives") {
        ...
        master_channel_fop.addVC(3, false, 1024, true, true, true, 32, 32, true, true, 32, true,
                                 SynchronizationFlag::OCTET_SYNCHRONIZED_FORWARD_ORDERED, 255, 10,
                                 10, 3, map_channels_fop);

        ServiceChannel serv_channel_fop = ServiceChannel(master_channel_fop, phy_channel_fop, SecurityAssociation(),
                                                         SecurityAssociation());
...
//	CHECK(serv_channel_fop.txAvailableTC(3, 2) == MaxReceivedTcInMapChannel);
    ...
    TEST_CASE("Retransmission") {
        ...
        master_channel.addVC(0, false, 128, true, true, true, 2, 2, false, false, 0, 8,
                             ...
                             map_channels);
        master_channel.addVC(1, false, 128, true, true, true, 2, 2, false, false, 0, 8,
                             SynchronizationFlag::OCTET_SYNCHRONIZED_FORWARD_ORDERED, 255, 10, 10, 3,
                             map_channels);
