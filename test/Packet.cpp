...
TEST_CASE("Transfer Frame TΜ Generation") {
    ...
    CHECK(transfer_frame.operational_control_field()[0] == 128);
    CHECK(transfer_frame.operational_control_field()[1] == 33);
    CHECK(transfer_frame.operational_control_field()[2] == 4);
    CHECK(transfer_frame.operational_control_field()[3] == 5);
//	CHECK(pckt.global_virtual_channel_id() == 32);
}
